...
public class AddSongPopup {
    ...
    public static void display(Playlist playlist, BorderPane root) {
        ...
        HBox close = new HBox(575);
        close.setMinWidth(700);
        Text title = new Text("Add Song");
        ...
        Button buttonAdd = Buttons.Small("Add");
        buttonAdd.setOnAction(e-> {
            PlaylistController.addSong(checkBoxMap, playlist, root);
            popup.hide();
        });
